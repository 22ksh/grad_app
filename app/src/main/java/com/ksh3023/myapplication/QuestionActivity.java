...
public class QuestionActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_EXIT = "com.ksh3023.gomin.exit";

    // AnswerActivity 시작 런처
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 버튼을 누르면 AnswerActivity 를 시작함
        Button questionButton = findViewById(R.id.buttonQuestion);
        questionButton.setOnClickListener(v -> startAnswerQuestion());

        // 달력 액티비티를 시작함
        Button calendarButton = findViewById(R.id.buttonCalendar);
        calendarButton.setOnClickListener(v -> startCalendarActivity());
    }

    private void startAnswerQuestion() {
        // AnswerActivity 를 시작함 (랜덤한 답변을 인텐트로 전달)
